...
<body>
 ...
 <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
  ...
  <div class="card-body">
   <h6 class="card-title text-center">Chúng tôi đã gửi mã về mail của bạn vui lòng kiểm tra !</h6>

   <div class="form-signin">
  <div class="form-label-group">
   <input type="email" class="form-control" placeholder="Email address" id="code" autofocus>
  ...
  <button class="btn btn-lg btn-primary btn-block text-uppercase" id="xacnhan">Xác Nhận</button>
  {{-- <hr class="my-4">
  <a class="btn btn-lg btn-google btn-block text-uppercase" href="#"><i class="fab fa-google mr-2"></i> Sign in with Google</a>
  <a class="btn btn-lg btn-facebook btn-block text-uppercase" href="#"><i class="fab fa-facebook-f mr-2"></i> Sign in with Facebook</a> --}}
...
<div id="myModal" class="modal fade">
 ...
 <div class="modal-header flex-column">
  ...
  <h4 class="modal-title w-100">Lỗi !</h4>

 </div>
 <div class="modal-body">
  <p>Vui lòng kiểm tra lại mã.</p>
 </div>
...
.trigger-btn {
 ...
 <div class="modal-content">
  ...
  <div class="modal-body">
  <p class="text-center">Tài khoản của bạn đã được xác minh.</p>
  </div>
